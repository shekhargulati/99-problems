...
import static com.shekhargulati.ninetynine_problems.java8.lists.CollectionUtils.arrayDeque;
...
public class P05Test {
    ...
    public void shouldReverseAList_IntStream() throws Exception {
        List<Integer> numbers = Arrays.asList(1, 2, 3, 4, 5);
        assertThat(P05.reverseIntStream(numbers), is(equalTo(Arrays.asList(5, 4, 3, 2, 1))));
    }
